...
public class Enemy {
    ...
    private int size;
    private double baseSpeed; // Velocidad base original
    private double speedMultiplier = 1.0; // Multiplicador de velocidad actual
    ...
    public Enemy(int x, int y, EnemyType type) {
        ...
        this.baseSpeed = ENEMY_SPEED; // Guardar velocidad base
        this.speed = this.baseSpeed; // Inicializar velocidad actual
    ...
    // Agregar este método en Enemy.java:
    ...
    private void updateSpeed() {
        switch (type) {
            case FOCA:
                ...
                break;
            case BIRD:
                this.speed = (baseSpeed * 1.5) * speedMultiplier;
                break;
            case ICE:
                this.speed = (baseSpeed * 0.8) * speedMultiplier;
                break;
        }
    }
    ...
    if (!initialized) {
        ...
        switch (type) {
            ...
            case ICE:
                this.speed = (baseSpeed * 0.8) * speedMultiplier;
                fallSpeed = 2.0 * speedMultiplier; // También acelerar caída
                break;
        }
    }
}
    ...
    private void updateStrong(Platform[][] platforms) {
        fallSpeed += 0.8 * speedMultiplier; // Acelerar incremento de caída
        if (fallSpeed > 8 * speedMultiplier) fallSpeed = 8 * speedMultiplier; // Límite escalado
